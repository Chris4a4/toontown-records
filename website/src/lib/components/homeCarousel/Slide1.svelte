<div class="flex flex-col items-center max-w-3xl font-righteous text-lightpink">
  ...
  <p class="text-justify text-2xl mb-8">This website contains a collection of all the records, which includes the fastest times and highest scores for bosses, facilities, activities, and more! You will also find leaderboards that show us the Top Toons with the most points. Check them all out!</p>
